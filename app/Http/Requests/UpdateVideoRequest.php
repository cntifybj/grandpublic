    ...
    public function rules(): array
    {
        return [
            'youtube_id' => [
                'required',
                'string',
                Rule::unique('videos', 'youtube_id')->ignore($this->route()->parameter('video'))
            ],
            'title' => [
                'required',
                'string',
                Rule::unique('videos', 'title')->ignore($this->route()->parameter('video'))
            ],
            'slug' => [
                'required',
                'string',
                Rule::unique('videos', 'slug')->ignore($this->route()->parameter('video'))
            ],
