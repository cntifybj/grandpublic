...
<?php $__env->startSection('content'); ?>
    ...
    <main id="main-content" class="grow lg:pt-0">
        ...
        <div class="form-container col-start-2 col-end-12 py-10 md:col-end-6 md:py-20 max-w-3xl mx-auto">
            ...
            <?php endif; ?>
                <form class=" flex flex-col gap-y-7" action="<?php echo e(route('password.email')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="group-[.is-error]:block mt-2 text-sm font-bold text-danger"><?php echo e($message); ?></p>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="pt-8">
                    <div
                        ...
                        Déjà un compte ? <a href="<?php echo e(route('login_page')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>