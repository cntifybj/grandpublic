...
<footer id="site-footer" class="dark">
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <div>
                        ...
                        <ul class="grid grid-cols-2 gap-x-4 gap-y-3 text-sm font-bold leading-normal">
                            ...
                            <li>
                                <a class="transition-colors text-primary hover:text-[#ee1a3b] dark:text-white dark:hover:text-[#ee1a3b]"
                                    href="<?php echo e(route('mentions.legales')); ?>">
                                    MENTIONS LÉGALES
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="transition-colors text-primary hover:text-[#ee1a3b] dark:text-white dark:hover:text-[#ee1a3b]"
                                    href="<?php echo e(route('conditions.utilisation')); ?>">
                            ...
                            <li>
                                <a class="transition-colors text-primary hover:text-[#ee1a3b] dark:text-white dark:hover:text-[#ee1a3b]"
                                    href="<?php echo e(route('politique.confidentialite')); ?>">
                ...
                <div class="col-span-full md:col-span-4">
                    ...
                    <div class="flex flex-col items-center md:items-start">
                        <h5 class="mb-5 mt-[4px] font-bold leading-none">
                            <img src="<?php echo e(asset('mygp-images/logo-gp.png')); ?>" alt="Logo" class="h-12 mb-2">
                        </h5>
    ...
    <div class="bg-gray-800 text-center text-white text-sm py-4">
        <p>&copy; Copyright <?php echo e(date('Y')); ?> - <a href="http://maxafrica.com" target="_blank"
...
<?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/partials/footer.blade.php ENDPATH**/ ?>