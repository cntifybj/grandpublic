<?php $__env->startSection('content'); ?>
    ...
    <main id="main-content" class="grow lg:pt-0">
        ...
        <br><br>
        <main id="main-content" class="grow lg:pt-0">
            <h1 class="titre text-[#ee1a3b] text-center mb-10 text-3xl font-bold leading-tight tracking-tight md:text-5xl"><?php echo e($currentPage); ?></h1>
            <section class="pt-14 pb-24 lg:pb-52 lg:pt-40">
                <div class="container">
                    ...
                    <div class="container mx-auto my-6">
                        <h2 class="hidden text-2xl font-semibold mb-4">Résultats pour "<?php echo e($searchTerm); ?>"</h2>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="hidden video-item border-b border-gray-300 py-4">
                                ...
                                <h3 class="hidden text-lg font-bold"><?php echo e($video->title); ?></h3>
                            ...
                            <div class="flex justify-center items-center my-6">
                                <div class="bg-gray-100 border border-gray-300 rounded-lg p-4 shadow-md text-center">
                                    <p class="text-lg font-semibold text-gray-700">
                                        Aucun résultat trouvé pour <span class="font-bold text-primary">"<?php echo e($searchTerm); ?>"</span>
                                    </p>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-span-full sm:col-span-6 lg:col-span-4 flex flex-col">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <ul class="flex justify-between leading-tight tracking-tight text-sm">
                                        ...
                                        <li><?php echo e(\Carbon\Carbon::parse($video->publication_date)->translatedFormat('d F Y')); ?></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/pages/search_result.blade.php ENDPATH**/ ?>