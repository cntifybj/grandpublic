        ...
        <div class="container mx-auto p-4 dark:bg-gray-900 overflow-hidden">
            <div class="dark:text-white video-history">
                ...
                <div class="video-list overflow-hidden">
                    <?php $__empty_1 = true; $__currentLoopData = $paid_videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="video-item">
                            <img src="<?php echo e($payment->video->video_thumbnail); ?>" alt="Thumbnail" class="thumbnail">
                            <div class="video-info">
                                <h4 class="dark:text-white text-lg font-semibold text-primary">
                                    <?php echo e($payment->video->title); ?>

                                </h4>
                                <p class="dark:text-white meta">Date d'achat:
                                    <span><?php echo e(\Carbon\Carbon::create($payment->created_at)->format('d F Y')); ?></span>
                                </p>
                            </div>
                            <a href="<?php echo e(route('video-watch', ['slug' => $payment->video->slug])); ?>"
                        ...
                        <div class="subscription-item">
                            <div class="subscription-info">
                                <p class="dark:text-white text-sm font-medium text-gray-600 dark:text-white mb-2">
                                    <strong>Date
                                        d'abonnement :</strong>
                                    <?php echo e(\Carbon\Carbon::create($subscription->start_date)->format('d F Y')); ?>

                                </p>
                                <p class="dark:text-white text-sm font-medium text-gray-600 dark:text-white mb-4">
                                    <strong>Date
                                        de fin :</strong>
                                    <?php echo e(\Carbon\Carbon::create($subscription->end_date)->format('d F Y')); ?>

                                </p>
                                <p class="dark:text-white text-sm font-medium text-gray-600 dark:text-white mb-4">
                                    <strong>Statut
                                        :</strong> <span
                                        class="font-semibold <?php echo e($subscription->expired ? 'text-[#ee1a3b] dark:text-[#ee1a3b]' : 'text-green-400 dark:text-green-400'); ?>"><?php echo e($subscription->expired ? 'Désactivé' : 'Active'); ?></span>
                                </p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/subscription/sub-page.blade.php ENDPATH**/ ?>