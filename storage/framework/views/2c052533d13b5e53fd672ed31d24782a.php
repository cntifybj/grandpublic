        ...
        <section class="relative pt-14 lg:pt-35">
                    ...
                    <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <h1 class="font-bold text-2xl sm:text-3xl text-primary dark:text-white mb-2">
                                <?php echo e($subscription['name']); ?></h1>
                            <h2 class="font-bold text-lg sm:text-xl text-primary dark:text-white">
                                <?php echo e($subscription['duration']); ?></h2>
                            <p class="text-3xl sm:text-4xl font-extrabold text-primary dark:text-white mb-4">
                                <?php echo e($subscription['price']); ?> XOF</p>
                            <p class="dark:text-white text-sm sm:text-base mb-6"><?php echo e($subscription['short_description']); ?></p>

                            <?php if(auth()->guard()->check()): ?>
                                <?php
                                    $payment_link = route('sub-pay') . '?type=' . $subscription['name'];
                                ?>
                                <button type="button" onclick="return window.location.href='<?php echo e($payment_link); ?>' "
                                    class="rounded-lg block w-full <?php echo e($loop->index === 2 ? 'bg-black' : 'bg-[#ee1a3b]'); ?> py-4 text-lg font-bold text-white transition-colors hover:bg-opacity-90 transform hover:-translate-y-1">
                                    Abonnez-vous
                                </button>
                            <?php endif; ?>
            ...
            <div id="loginModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 text-center">
                    ...
                    <div class="flex justify-center space-x-4">
                        <button onclick="window.location='<?php echo e(route('login_page', ['redirect' => url()->current()])); ?>'"
            ...
            <script>
                function showModal() {
                    ...
                    fetch('<?php echo e(route('set.redirect')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/subscription/sub-add.blade.php ENDPATH**/ ?>