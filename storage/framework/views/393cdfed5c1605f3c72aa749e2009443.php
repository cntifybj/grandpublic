...
<div class="container mx-auto p-3">
    ...
    <p class="mb-4">
        Pour en savoir plus sur la collecte et le traitement de vos données personnelles, consultez notre <a href="<?php echo e(route('politique.confidentialite')); ?>" class="text-blue-600 hover:underline">Politique de Confidentialité</a>.
    </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/pages/mentions-legales.blade.php ENDPATH**/ ?>