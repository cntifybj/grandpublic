        ...
        <main id="main-content" class="grow lg:pt-0">
            ...
            <section class="pt-14 pb-24 lg:pb-52 lg:pt-40">
                <div class="container">
                    ...
                    <div id="videoGrid" class="grid grid-cols-12 gap-y-14 sm:gap-x-[30px] min-h-[500px] mt-[-90px]">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/pages/insolite.blade.php ENDPATH**/ ?>