                        ...
                        <div
                            ...
                            <div class="overflow-hidden col-start-2 md:col-start-6 col-end-12">
                                <form id="contactForm" class="overflow-x-hidden grid grid-cols-1 md:grid-cols-2 gap-7"
                                    method="POST" action="<?php echo e(route('user_message.store')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/pages/contact.blade.php ENDPATH**/ ?>