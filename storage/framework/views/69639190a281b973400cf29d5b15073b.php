<div id="site-wrapper" class="flex flex-col h-full js-site-wrapper">
    <div class="header-wrapper bg-[#ee1a3b] text-white relative z-30">
            ...
            <div class="container">
                <nav class="flex min-h-[64px] items-center justify-between pt-1 lg:min-h-[90px] lg:pt-4">
                    ...
                    <div class="logo-container flex flex-col h-full js-site-wrapper">
                        <a href="<?php echo e(route('home')); ?>">
                            <div class="logo-wrapper">
                                <img src="<?php echo e(asset('mygp-images/logo-gp.png')); ?>" alt="Logo Grand Public"
                    ...
                    <ul class="hidden lg:flex gap-x-7 xl:gap-x-10 text-sm font-bold lg:flex flex-wrap justify-center">
                        ...
                        <li
                            class="<?php echo e(Route::currentRouteName() == 'portrait' ? 'active no-hover-effect' : ''); ?> relative [&>.sub-menu]:hover:visible [&>.sub-menu]:hover:animate-popper-pop-in [&>.sub-menu]:hover:opacity-100">
                            <a class="flex flex-col h-full js-site-wrapper relative inline-flex items-center gap-x-2 leading-10 after:absolute after:bottom-[7px] after:left-0 after:h-[2px] after:bg-white after:transition-transform after:w-full after:origin-right hover:after:origin-left after:scale-x-0 hover:after:scale-x-100"
                                href="<?php echo e(route('portrait')); ?>">
                                PORTRAIT
                            </a>
                        </li>
                        <li
                            class="<?php echo e(Route::currentRouteName() == 'events' ? 'active no-hover-effect' : ''); ?> relative [&>.sub-menu]:hover:visible [&>.sub-menu]:hover:animate-popper-pop-in [&>.sub-menu]:hover:opacity-100">
                            <a class="flex flex-col h-full js-site-wrapper relative inline-flex items-center gap-x-2 leading-10 after:absolute after:bottom-[7px] after:left-0 after:h-[2px] after:bg-white after:transition-transform after:w-full after:origin-right hover:after:origin-left after:scale-x-0 hover:after:scale-x-100"
                        ...
                        <li
                            class="<?php echo e(Route::currentRouteName() == 'opinion' ? 'active no-hover-effect' : ''); ?> relative [&>.sub-menu]:hover:visible [&>.sub-menu]:hover:animate-popper-pop-in [&>.sub-menu]:hover:opacity-100">
                            <a class=" relative inline-flex items-center gap-x-2 leading-10 after:absolute after:bottom-[7px] after:left-0 after:h-[2px] after:bg-white after:transition-transform after:w-full after:origin-right hover:after:origin-left after:scale-x-0 hover:after:scale-x-100"
                                href="<?php echo e(route('opinion')); ?>">
                                OPINION
                            </a>
                        </li>
                        <li
                            class="<?php echo e(Route::currentRouteName() == 'insolite' ? 'active no-hover-effect' : ''); ?> relative [&>.sub-menu]:hover:visible [&>.sub-menu]:hover:animate-popper-pop-in [&>.sub-menu]:hover:opacity-100">
                            <a class="relative inline-flex items-center gap-x-2 leading-10 after:absolute after:bottom-[7px] after:left-0 after:h-[2px] after:bg-white after:transition-transform after:w-full after:origin-right hover:after:origin-left after:scale-x-0 hover:after:scale-x-100"
                                href="<?php echo e(route('insolite')); ?>">
                                INSOLITE
                            </a>
                        </li>
                    ...
                    <div class="flex items-center py-4 px-1 sm:px-2 space-x-4">
                        ...
                        <a href="<?php echo e(route('sub-add')); ?>"
                        ...
                        <div class="flex">
                            ...
                            <div class="flex items-center py-4 px-1 sm:px-2">
                                <label for="theme-toggle" class="relative inline-flex cursor-pointer items-center">
                                    ...
                                    <svg role="img"
                                        ...
                                        <?php if(Route::is('videos.search') || Route::is('videos.search')): ?>
                                            <use xlink:href="/assets/img/yt1/sprite.svg#sun"></use>
                                        <?php endif; ?>
                                    </svg>
                            ...
                            <div
                                ...
                                <?php if(Auth::check()): ?>
                                    <a class="block py-4 px-2 xl:px-3" href="<?php echo e(route('account')); ?>">
                                        <?php if(request()->is('watch-video')): ?>
                                        ...
                                        <?php else: ?>
                                            <svg role="img" class="h-6 w-6 fill-white">
                                                <use xlink:href="<?php echo e(asset('assets/img/yt1/sprite.svg#user')); ?>"></use>
                                            </svg>
                                        <?php endif; ?>
                                    </a>
                                <?php endif; ?>
                                ...
                                <ul
                                    ...
                                    <?php if(Auth::check()): ?>
                                        ...
                                        <li class="px-7">
                                            <a class="flex flex-row-reverse items-center justify-between py-2 text-primary dark:text-white transition-colors hover:text-[#ee1a3b] dark:hover:text-[#ee1a3b]"
                                                href="<?php echo e(route('sub-page')); ?>">
                                                HISTORIQUE
                                            </a>
                                        </li>
                                    <?php endif; ?>
        ...
        <!-- Mobile Menu / End -->
<?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/partials/navbar.blade.php ENDPATH**/ ?>