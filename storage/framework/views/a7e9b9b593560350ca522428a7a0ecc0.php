                ...
                <div class="swiper-wrapper vv-hero-swiper-wrapper">
                    ...
                    <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide group">
                            <div
                                class="absolute inset-0 -z-10 h-full w-full bg-[url('<?php echo e(Storage::url($slide->image)); ?>')] bg-cover bg-center bg-no-repeat opacity-0 transition-opacity duration-[2000ms] ease-out group-[.swiper-slide-active]:opacity-100">
                                <style>
                                    @media (max-width: 640px) {
                                        .bg-[url('<?php echo e(Storage::url($slide->image)); ?>')] {
                                            background-image: url('<?php echo e(Storage::url($slide->image)); ?>');
        ...
        <main id="main-content" class="grow lg:pt-0">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    ...
                                                    <ul class="flex text-sm leading-tight tracking-tighter">
                                                        <li class="mr-2"><?php echo e($video->youtube_view_count); ?> vues</li>
                                                        <li class="ml-auto">
                                                            <?php echo e(\Carbon\Carbon::parse($video->publication_date)->translatedFormat('d F Y')); ?>
            ...
            <section class="py-8 md:py-14 lg:py-16 xl:py-[75px]">
                <div class="container mx-auto px-4">
                    ...
                    <?php $__currentLoopData = $orderedCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $videos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($videos) > 0): ?>
                            <div class="category-section relative mb-20">
                                <div class="mb-4 flex items-center justify-between">
                                    <a href="<?php echo e(route(strtolower($categoryName))); ?>">
                                        <h3 class="text-2xl font-bold uppercase text-[#d81a3b] lg:text-4xl">
                                            <?php echo e($categoryName); ?></h3>
                                    </a>
                                    <div class="flex space-x-4">
                                        <div
                                            class="swiper-button-prev-<?php echo e(strtolower($categoryName)); ?> flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-black text-white transition-colors duration-200 hover:bg-[#d81a3b]">
                                        ...
                                        <div
                                            class="swiper-button-next-<?php echo e(strtolower($categoryName)); ?> flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-black text-white transition-colors duration-200 hover:bg-[#d81a3b]">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor" class="h-6 w-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 5l7 7-7 7" />
                                ...
                                <div class="swiper-<?php echo e(strtolower($categoryName)); ?> overflow-hidden">
                                                    ...
                                                    <figure class="mb-6 aspect-video">
                                                        <a class="group relative block h-full overflow-hidden bg-gray-900"
                                                            ...
                                                            <img class="h-full w-full object-cover transition-all duration-300 group-hover:scale-110 group-hover:opacity-75"
                                                                src="<?php echo e($video->video_thumbnail); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/home.blade.php ENDPATH**/ ?>