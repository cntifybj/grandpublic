<div class="offcanvas offcanvas-end" tabindex="-1" id="addStaffMember" aria-labelledby="addStaffMemberLabel">
    ...
    <div class="offcanvas-body">
        ...
        <form method="POST" action="<?php echo e(route('backoffice.staff.store')); ?>" id="addStaffMemberForm">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/backoffice/pages/staff/formAdd.blade.php ENDPATH**/ ?>