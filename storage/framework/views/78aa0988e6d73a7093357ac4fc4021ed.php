    ...
    <div class="sidebar-logo">
        ...
        <div class="logo-header pt-4" data-background-color="dark">
            ...
            <a href="<?php echo e(route('backoffice.index')); ?>" class="logo">
                <img src="<?php echo e(asset('mygp-images/LogoGP.png')); ?>" alt="navbar brand" class="navbar-brand" height="65px"
            ...
            <ul class="nav nav-secondary">
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.videos.index')); ?>">
                            ...
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.videos.create')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="ms-3">
                                <a href="<?php echo e(route('backoffice.user.index')); ?>">
                                    <i class="fas fa-list"></i>
                                    <span class="sub-item">Liste des utilisateurs</span>
                                </a>
                            </li>
                            <li class="ms-3">
                                <a href="<?php echo e(route('backoffice.user_message.index')); ?>">
                                    <i class="fas fa-list"></i>
                                    <span class="sub-item">Messages (Formulaire de Contact)</span>
                                </a>
                            </li>
                            <li class="ms-3">
                                <a href="<?php echo e(route('backoffice.user.center_of_interest.index')); ?>">
                                    <i class="fas fa-list"></i>
                ...
                <li class="nav-item">
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="ms-3">
                                <a href="<?php echo e(route('backoffice.comment.index')); ?>">
                                    <i class="fas fa-list"></i>
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.user_subscription.index')); ?>">
                            ...
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.subscription.index')); ?>">
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.slides.index')); ?>">
                            ...
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.slides.create')); ?>">
                            ...
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.slide.sort_page')); ?>">
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.advisories.index')); ?>">
                                    <i class="fas fa-th-list"></i>
                            ...
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.advisories.create')); ?>">
                                    <i class="fas fa-plus-square"></i>
                        ...
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <ul class="nav nav-collapse">
                                <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <a href="<?php echo e(route('backoffice.staff.index')); ?>">
                                        <i class="fas fa-list-alt"></i>
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <ul class="nav nav-collapse">
                            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                <a href="<?php echo e(route('backoffice.app_notifs.index')); ?>">
                                    <i class="fas fa-list-alt"></i>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('backoffice.auth.do_logout')); ?>">
...
<?php /**PATH /home/blowmusi/public_html/grandpublic/resources/views/backoffice/partials/sidebar.blade.php ENDPATH**/ ?>