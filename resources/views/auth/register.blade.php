    ...
    <main id="main-content" class="grow lg:pt-0">
        ...
        <script>
            function closeNotification() {
                ...
                <form class="flex flex-col gap-y-7 overflow-hidden" action="{{ route('register') }}" method="POST">
                    @csrf
                    <div>
                        <input
                    ...
                    <div>
                        <input
                            ...
                            @error('email')
                            <span class="font-bold text-sm text-red-600 mt-2 block">{{ $message }}</span>
                        @enderror
                        </div>
                    ...
                    <div class="flex items-center gap-x-3">
                        ...
                        <span class="text-sm font-bold text-primary dark:text-white">
                            <a href="{{ route('conditions.utilisation') }}" class="hover:underline hover:text-[#ee1a3b]">
