...
@section('page_content')
    <div class="container px-5">
        ...
        <form method="POST" action="{{ route('backoffice.videos.store') }}" id="addVideoForm" enctype="multipart/form-data">
            @csrf
...
@section('page_scripts')
    ...
    <script src="{{ asset('assets/backoffice/js/pages/video/create.js') }}"></script>
@endsection
