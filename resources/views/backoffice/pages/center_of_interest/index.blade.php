...
@section('page_content')
    <div class="container mt-4">
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">Ajouter un centre d'intérêt</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                <!-- Formulaire d'ajout-->
                                @include('backoffice.pages.center_of_interest.formAdd')
                            </div>
                        </div>
                    </div>
        ...
        @include('backoffice.pages.center_of_interest.deleteModal')

        <!-- Offcanvas d'édition -->
        @include('backoffice.pages.center_of_interest.formUpdate')
    </div>
    @endsection
    ...
    @section('page_scripts')
        ...
        <script>
            const FETCHDATAURL = "{{ route('backoffice.user.center_of_interest.fetch_all') }}"
        </script>

        <script src="{{ asset('assets/backoffice/js/pages/center_of_interest/index.js') }}"></script>
    @endsection
