        ...
        <main id="main-content" class="grow lg:pt-0">
            ...
            <section class="pt-14 pb-24 lg:pb-52 lg:pt-40">
                <div class="container">
                            ...
                            <div class="bg-gray-100 border border-gray-300 rounded-lg p-4 shadow-md text-center">
                                <p class="text-lg font-semibold text-gray-700">
                                    Aucun résultat trouvé pour <span
                                        class="font-bold text-primary">"{{ $searchTerm }}"</span>
                                </p>
                            </div>
                        </div>
                    @endif
                                    ...
                                    toggle.addEventListener('click', e => {
                                        ...
                                        if (cols) {
                                            videoItems.forEach(item => {
                                                ...
                                                item.classList.add(cols === '3' ? 'lg:col-span-4' :
                                                    'lg:col-span-3');
                                            });
                                        }
                                    });
                    ...
                    <nav aria-label="Pagination" id="pagination-container"
                            ...
                            function styleActivePage() {
                                ...
                                links.forEach(link => {
                                    ...
                                    if (link.getAttribute('aria-current') === 'page') {
                                        link.classList.add('bg-[#ee1a3b]', 'text-white', 'border-[#ee1a3b]',
                                            'dark:text-white');
                                    }
                                });
                            }
