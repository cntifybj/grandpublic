...
@section('content')
    ...
    <div class="bg-height-mobile relative bg-cover bg-center bg-no-repeat md:min-h-[600px]">
        <div class="container relative z-10 mx-auto flex h-full flex-col items-start justify-center px-4">
            ...
            <script>
                const images = {!! json_encode($headSlideImagesUrl) !!};
            ...
            <div
                ...
                <div class="mb-4 flex justify-start">
                    <a class="text-2xl font-bold uppercase text-[#d81a3b] lg:text-4xl" href="{{ route($video->category) }}">
                        {{ $video->category }}
                    </a>
            ...
            <article
                ...
                <div class="col-span-full grid grid-cols-8 gap-x-4 md:col-start-2 md:col-end-12 md:gap-x-6 lg:gap-x-[30px]">
                        ...
                        <div class="vv-prose">
                            ...
                            <div class="yt-video-meta">
                                <span>
                                    ...
                                    @endphp
                                    {{ isset($video) && $youtubeViews ? $youtubeViews : 0 }}
                                    Vue{{ isset($video) && $youtubeViews > 1 ? 's' : '' }}
                                </span>
                                <span>
                    ...
                    <div
                        ...
                        <h3 @php
$nb_comments = $video->comments()->where('deleted', false)->get()->count(); @endphp
                            ...
                            <span class="text-[#ee1a3b]">{{ $nb_comments }}</span>
                            Commentaire{{ $nb_comments > 1 ? 's' : '' }}
                        </h3>
                        ...
                        <script>
                            const banners = {!! json_encode($bottomSlideImagesUrl) !!};
                        ...
                        <ol class="mt-30 text-lg leading-8 tracking-tight">
                            @foreach ($video->comments()->where('deleted', false)->get() as $comment)
                                    ...
                                    <li class="mb-8 lg:mb-12" id="comment-{{ $comment->id }}">
                                        <div class="flex gap-x-4">
                                            ...
                                            <div class="flex-grow">
                                                ...
                                                @auth
                                                    <div class="reply-form mb-4 hidden" id="reply-form-{{ $comment->id }}">
